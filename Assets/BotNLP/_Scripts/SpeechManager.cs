...
public class SpeechManager : MonoBehaviour {
    ...
    public CleverTalk.View.AvatarBlendShapes blendShape;
    ...
    void Start () {
        ...
        Task<string> authenticating = auth.Authenticate("https://westus2.api.cognitive.microsoft.com/sts/v1.0/issueToken",
                                                 "c816250585c44eb39144c8f23a7238f2"); // INSERT-YOUR-BING-SPEECH-API-KEY-HERE
    ...
    private void PlayAudio(Stream audioStream)
    {
        ...
        Debug.Log("Size of the audio stream : " + size);
        ...
        if (size > 0)
        {
            try
            {
                ...
                var clip = ToClip("Tempest", unityData, sampleCount, frequency);
               ...
               model.GetComponent<SimpleLipSyncBlend>().StartTalking(blendShape);
             //   model.GetComponent<SimpleLipSyncJAW>().StartTalking();

                 //model.GetComponent<LipSync>().Play(newData);
                // Play audio
                // audioSource.Play();
            }
            catch (Exception ex)
    ...
    private IEnumerator WaitAndPlayRoutine(Task<Stream> speakTask)
    {
        ...
        if (resultStream != null)
        {
            ...
            APIManager.instance.isBotResponseDone = true;
        }
    ...
    public void Speak(string message)
    {
        ...
        try
        {
            ...
            // string requestUri = "https://westus2.tts.speech.microsoft.com/cognitiveservices/v1";
            // Edited on 7-8-2019 : for pournima voice
            string requestUri = "https://westus2.voice.speech.microsoft.com/cognitiveservices/v1?deploymentId=72fb3cf3-3fb0-4b71-8c2f-1afd56466e5a";
            Synthesize cortana = new Synthesize();
            Debug.Log("access token used : " + accessToken);
