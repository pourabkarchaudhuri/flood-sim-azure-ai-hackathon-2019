...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_FloodedArea p_FloodedArea;
        ...
        public static SteamVR_Input_ActionSet_FloodedArea FloodedArea
        {
            get
            {
                return SteamVR_Actions.p_FloodedArea.GetCopy<SteamVR_Input_ActionSet_FloodedArea>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_FloodedArea = ((SteamVR_Input_ActionSet_FloodedArea)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_FloodedArea>("/actions/FloodedArea")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.FloodedArea};
        }
    }
}
